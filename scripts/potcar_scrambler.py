# NOTE this was copied directly from pymatgen/dev_scripts/potcar_scramber.py on Sept 10, 2025
# only modifications are the addition of user inputs for ease of use...
...
input_potcar = input("Path to real POTCAR: ")
output_potcar = input("Path to create fake POTCAR: ")
...
PotcarScrambler.from_file(
    input_filename=input_potcar,
    output_filename=output_potcar,
)
